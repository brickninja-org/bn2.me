...
import { getBn2MeUrl, getPKCEPair } from '@/lib/client';
...
export default async function FedCmPage() {
  return (
    <main className="container mx-auto max-w-7xl mb-8 px-6 grow">
      ...
      <FedCm clientId={process.env.DEMO_CLIENT_ID!} bn2meUrl={getBn2MeUrl()} pkceChallenge={(await getPKCEPair()).challenge}/>
    </main>
  );
}
